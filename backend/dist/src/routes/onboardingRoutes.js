...
const onboardingController_1 = __importStar(require("../controllers/onboardingController"));
...
// Set user goal
router.post('/goal', onboardingController_1.setGoal);
router.post('/summary', onboardingController_1.default.completeOnboarding);
// placeholder
